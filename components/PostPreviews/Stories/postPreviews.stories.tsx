...
export default {
  title: 'Page/Components/PostPreviews/PostPreviews',
  ...
  Posts: [
    {
      ...
      ShortBody: 'Here is my first post about my blog, its  agood post',
      Body:
